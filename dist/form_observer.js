...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormObserver", function() { return FormObserver; });
/* harmony import */ var mdn_polyfills_Object_assign__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! mdn-polyfills/Object.assign */ "./node_modules/mdn-polyfills/Object.assign.js");
/* harmony import */ var mdn_polyfills_Object_assign__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(mdn_polyfills_Object_assign__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _core_FormControlsCollection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./core/FormControlsCollection */ "./src/core/FormControlsCollection.js");
...
function () {
  ...
  function FormObserver(settings) {
    ...
    _classCallCheck(this, FormObserver);
  ...
  _createClass(FormObserver, [{
    ...
    value: function serializeControls(target) {
       ...
       */
      var formElements = new _core_FormControlsCollection__WEBPACK_IMPORTED_MODULE_1__["FormControlsCollection"](target, this._settings);
      return formElements;
    }
    /**
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (function (condition) {
  if (condition) {
    var _console;
...
/***/ "./src/core/FormControlsCollection.js":
/*!********************************************!*\
  !*** ./src/core/FormControlsCollection.js ***!
  \********************************************/
/*! exports provided: FormControlsCollection */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FormControlsCollection", function() { return FormControlsCollection; });
...
/* harmony import */ var mdn_polyfills_Object_entries__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! mdn-polyfills/Object.entries */ "./node_modules/mdn-polyfills/Object.entries.js");
/* harmony import */ var mdn_polyfills_Object_entries__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(mdn_polyfills_Object_entries__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _ConsoleExtend__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ConsoleExtend */ "./src/core/ConsoleExtend.js");
/* harmony import */ var _HTMLRadioGroup__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./HTMLRadioGroup */ "./src/core/HTMLRadioGroup.js");
...
function () {
  ...
  function FormControlsCollection(target, settings) {
    _classCallCheck(this, FormControlsCollection);
  ...
  _createClass(FormControlsCollection, [{
    key: "_parseControls",
    value: function _parseControls() {
      ...
      function (control) {
        ...
        if (controlType === 'radio') {
           ...
           * @type {HTMLRadioGroup}
           */
          var htmlRadioGroup = _HTMLRadioGroup__WEBPACK_IMPORTED_MODULE_4__["HTMLRadioGroup"].parse(_this._controls['_' + name]); // If the key has already been added, concat the new control with the existing ones

          if (htmlRadioGroup) {
            htmlRadioGroup.add(control);
          } else {
            _this._controls['_' + name] = new _HTMLRadioGroup__WEBPACK_IMPORTED_MODULE_4__["HTMLRadioGroup"](control);
          }
        } else {
    ...
    value: function _addEventListeners(control) {
      ...
      function (e) {
        ...
        Object(_ConsoleExtend__WEBPACK_IMPORTED_MODULE_3__["default"])(_this2._settings.consoleVerbose, 'OnControlInput');
    ...
    value: function _createGetter(name) {
      ...
      return {
        get: function get() {
          Object(_ConsoleExtend__WEBPACK_IMPORTED_MODULE_3__["default"])(_this3._settings.consoleVerbose, 'Getter');
    ...
    value: function _createSetter(name) {
      ...
      return {
        ...
        function set(newValue) {
          ...
          Object(_ConsoleExtend__WEBPACK_IMPORTED_MODULE_3__["default"])(_this4._settings.consoleVerbose, 'Setter'); // Updates the value in the object
    ...
    value: function _setControlValue(control, value) {
      ...
      Object(_ConsoleExtend__WEBPACK_IMPORTED_MODULE_3__["default"])(this._settings.consoleVerbose, 'SetControlValue');
      ...
      if (this._settings.triggerChangeOnSetter && !stopPropagation) {
        ...
        Object(_ConsoleExtend__WEBPACK_IMPORTED_MODULE_3__["default"])(this._settings.consoleVerbose, 'DispatchChangeEvent');
    ...
    value: function getControl(name) {
      Object(_ConsoleExtend__WEBPACK_IMPORTED_MODULE_3__["default"])(this._settings.consoleVerbose, 'getControl(' + name + ')');
...
/***/ "./src/core/HTMLRadioGroup.js":
/*!************************************!*\
  !*** ./src/core/HTMLRadioGroup.js ***!
  \************************************/
/*! exports provided: HTMLRadioGroup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HTMLRadioGroup", function() { return HTMLRadioGroup; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
